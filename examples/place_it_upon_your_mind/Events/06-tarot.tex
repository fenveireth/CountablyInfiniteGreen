...
\option [FenJump]
% \hidden{MY_CONDITION == 1} % If this test fails, icon is not placed on map
% \if{MY_CONDITION == 1} % If this test fails, icon is greyed out and inactive
\set{TEMP_P4A_SELECTED = 0} \set{TEMP_FALL = 0}
